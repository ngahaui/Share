...
<head>
	...
	<?php include_once'views/mod/sub/head.php' ?>
</head>
<body>
	<?php include_once'views/mod/sub/menu.php' ?>
	<div class="panel panel-primary col-lg-10 col-lg-offset-1" style="margin-top: 70px; padding: 0">
		<div class="panel-heading">
			<div class="row">
				<div class="col-md-8"><?php echo $Cate_Book->category_name ?></div>
				<div class="col-md-4">
